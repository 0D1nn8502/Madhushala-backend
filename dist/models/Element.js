...
exports.ElementModel = exports.SpaceElementModel = void 0;
const mongoose_1 = __importStar(require("mongoose"));
const ElementSchema = new mongoose_1.Schema({
    name: { type: String, required: true },
    imageUrl: { type: String, required: true },
    scale: { type: Number, default: 1 },
    spaces: [{ type: mongoose_1.Schema.Types.ObjectId, ref: 'Space' }] // Reference to spaces
});
const SpaceElementSchema = new mongoose_1.Schema({
